...
public class Test extends JFrame {
    ...
    public Test() {
        ...
        JTextPane paragraph22 = new JTextPane();
        paragraph22.setContentType("text/html");
        paragraph22.setEditable(false);
        StyledDocument paragraph22Doc = paragraph22.getStyledDocument();
        paragraph22.setMargin(new Insets(10, 10, 10, 10));

        Style regular22 = paragraph22Doc.addStyle("regular", null);
        StyleConstants.setFontFamily(regular22, "SansSerif");

        try {
            paragraph22Doc.insertString(paragraph22Doc.getLength(), "This is a horizontal line:", regular22);
        } catch (BadLocationException e) {
            e.printStackTrace();
        }

        paragraph22.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(paragraph22);

        // Paragraph 23 - Paragraph
        String paragraph23Html = "<html><body style='width: %1spx'>%1s</body></html>";
        JLabel paragraph23 = new JLabel(String.format(paragraph23Html, 400, ""));
        paragraph23.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10),
                BorderFactory.createMatteBorder(0, 0, 1, 0, java.awt.Color.GRAY)));
        ...
        JTextPane paragraph24 = new JTextPane();
        paragraph24.setContentType("text/html");
        paragraph24.setEditable(false);
        StyledDocument paragraph24Doc = paragraph24.getStyledDocument();
        paragraph24.setMargin(new Insets(10, 10, 10, 10));

        paragraph24.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10),
                BorderFactory.createMatteBorder(0, 3, 0, 0, Color.DARK_GRAY)));
        Style regular24 = paragraph24Doc.addStyle("regular", null);
        StyleConstants.setFontFamily(regular24, "SansSerif");

        try {
            paragraph24Doc.insertString(paragraph24Doc.getLength(), "    This is a block quote", regular24);
        } catch (BadLocationException e) {
            e.printStackTrace();
        }

        paragraph24.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(paragraph24);
        ...
        try {
            paragraph25Doc.insertString(paragraph25Doc.getLength(), "This is a paragraph with a table:", regular25);
        } catch (BadLocationException e) {
            e.printStackTrace();
        }
        ...
        // Paragraph 26 - Table
        String[] table26Columns = { "Header 1", "Header 2", "Header 3" };
        String[][] table26Rows = { { "Row 1", "Row 1", "Row 1" }, { "Row 2", "Row 2", "Row 2" },
                { "Row 3", "Row 3", "Row 3" } };
        JTable table26 = new JTable(table26Rows, table26Columns) {
            public boolean isCellEditable(int row, int column) {
                return false;
            }
        };
        table26.getTableHeader().setReorderingAllowed(false);
        table26.setRowHeight(25);
        JScrollPane table26ScrollPane = new JScrollPane(table26);
        table26ScrollPane.setPreferredSize(new Dimension(400, 100));

        table26ScrollPane.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(table26ScrollPane);

        // Paragraph 27 - Code
        JTextArea codeBlock27TextArea = new JTextArea(
                "public class Main {\n    public static void main(String[] args) {\n        System.out.println(\"Hello, World!\");\n    }\n}");
        codeBlock27TextArea.setFont(new Font("Monospaced", Font.PLAIN, 12));
        codeBlock27TextArea.setBackground(new Color(50, 50, 50));
        codeBlock27TextArea.setForeground(Color.WHITE);
        codeBlock27TextArea.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        JScrollPane codeBlock27ScrollPane = new JScrollPane(codeBlock27TextArea);
        codeBlock27ScrollPane.setBackground(java.awt.Color.WHITE);
        codeBlock27ScrollPane.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
        codeBlock27ScrollPane.setPreferredSize(new Dimension(300, 150));

        codeBlock27ScrollPane.setAlignmentX(Component.LEFT_ALIGNMENT);
        mainPanel.add(codeBlock27ScrollPane);
